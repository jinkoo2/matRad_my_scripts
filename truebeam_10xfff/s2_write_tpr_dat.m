% s2_write_tpr_dat.m  –  TrueBeam 10XFFF (10MV FFF)

clear; clc;

outputFile = '/gpfs/projects/KimGroup/projects/tps/matRad/photonPencilBeamKernelCalc/truebeam_10xfff/tpr.dat';
csvFile   = '/gpfs/projects/KimGroup/projects/tps/matRad/my_scripts/TrueBeamGBD/10FFF Beam Data/Open Field Depth Dose.csv';
