...
% dmax for 10 MV FFF is ~24 mm, so 2.4 cm is the closest available depth
% to the surface, minimizing phantom scatter in the primary fluence estimate.
csvFile    = '/gpfs/projects/KimGroup/projects/tps/matRad/my_scripts/TrueBeamGBD/10FFF Beam Data/Open Field Profiles at 2.4cm.csv';
outputFile = '/gpfs/projects/KimGroup/projects/tps/matRad/photonPencilBeamKernelCalc/truebeam_10xfff/primflu.dat';
