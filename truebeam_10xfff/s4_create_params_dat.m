...
% Write params.dat for the TrueBeam 10XFFF (10MV FFF) photon pencil-beam kernel.

clear; clc;

outputFile = '/gpfs/projects/KimGroup/projects/tps/matRad/photonPencilBeamKernelCalc/truebeam_10xfff/params.dat';
...
fprintf(fid, 'photon_energy 10.0\n');
