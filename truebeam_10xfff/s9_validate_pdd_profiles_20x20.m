%% s7_validate_pdd_profiles_20x20.m  –  TrueBeam 10XFFF (10MV FFF)
...
figure('Name','PDD – 20x20 cm², TrueBeam 10XFFF','Position',[50 100 700 500]);
...
title('PDD – TrueBeam 10XFFF, 20×20 cm², SSD=100 cm');
...
for k = 1:length(profile_depths_cm)
    figure('Name', sprintf('Profile %.1fcm – 20x20 cm²', profile_depths_cm(k)), ...
    ...
    ylabel('Relative Dose [%]');
    title(sprintf('Profile at %.1f cm (grid: %.1f mm) – TrueBeam 10XFFF, 20×20 cm²', ...
...
%% 15. Save
save('s9_water_phantom_20x20_10xfff_results.mat', ...
    ...
    'profile_depths_cm');
fprintf('\nSaved: s9_water_phantom_20x20_10xfff_results.mat\n');
