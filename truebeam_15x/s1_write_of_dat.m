% s1_write_of_dat.m  –  TrueBeam 15X (15MV flat)

clear; clc;

outFile = '/gpfs/projects/KimGroup/projects/tps/matRad/photonPencilBeamKernelCalc/truebeam_15x/of.dat';
csvFile = '/gpfs/projects/KimGroup/projects/tps/matRad/my_scripts/TrueBeamGBD/15MV Beam Data/Open field Output Factors.csv';
