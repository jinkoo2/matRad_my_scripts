% s2_write_tpr_dat.m  –  TrueBeam 15X (15MV flat)

clear; clc;

outputFile = '/gpfs/projects/KimGroup/projects/tps/matRad/photonPencilBeamKernelCalc/truebeam_15x/tpr.dat';
csvFile   = '/gpfs/projects/KimGroup/projects/tps/matRad/my_scripts/TrueBeamGBD/15MV Beam Data/Open Field Depth Dose.csv';
