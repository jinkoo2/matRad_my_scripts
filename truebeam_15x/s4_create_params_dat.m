...
% Write params.dat for the TrueBeam 15X (15MV flat) photon pencil-beam kernel.

clear; clc;

outputFile = '/gpfs/projects/KimGroup/projects/tps/matRad/photonPencilBeamKernelCalc/truebeam_15x/params.dat';
...
fprintf(fid, 'photon_energy 15.0\n');
