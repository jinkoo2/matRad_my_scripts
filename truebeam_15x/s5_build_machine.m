% s5_build_machine.m  –  TrueBeam 15X (15MV flat)
% Generate the TrueBeam 15X matRad machine file by:
...
inputDir  = fullfile(toolboxRoot, 'truebeam_15x');
machineName = 'TrueBeam_15X';

fprintf('\n=== s5: building machine ===\n');
machine = ppbkc_generateBaseData(machineName, inputDir);

%% Step 3: Save
outFile = '/gpfs/projects/KimGroup/projects/tps/matRad/userdata/machines/photons_TrueBeam_15X.mat';
