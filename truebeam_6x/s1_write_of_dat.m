% s1_write_of_dat.m  –  TrueBeam 6X (6MV flat)

clear; clc;

outFile = '/gpfs/projects/KimGroup/projects/tps/matRad/photonPencilBeamKernelCalc/truebeam_6x/of.dat';
csvFile = '/gpfs/projects/KimGroup/projects/tps/matRad/my_scripts/TrueBeamGBD/6MV Beam Data/Open field Output Factors.csv';
...
x_sizes = cell2mat(raw(7, 3:end));  % [3 4 5 7 10 15 20 30 40]
