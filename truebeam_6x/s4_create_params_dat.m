...
% Write params.dat for the TrueBeam 6X (6MV flat) photon pencil-beam kernel.

clear; clc;

outputFile = '/gpfs/projects/KimGroup/projects/tps/matRad/photonPencilBeamKernelCalc/truebeam_6x/params.dat';
