% s5_build_machine.m  –  TrueBeam 6X (6MV flat)
% Generate the TrueBeam 6X matRad machine file by:
...
inputDir  = fullfile(toolboxRoot, 'truebeam_6x');
machineName = 'TrueBeam_6X';

fprintf('\n=== s5: building machine ===\n');
machine = ppbkc_generateBaseData(machineName, inputDir);

%% Step 3: Save
outFile = '/gpfs/projects/KimGroup/projects/tps/matRad/userdata/machines/photons_TrueBeam_6X.mat';
