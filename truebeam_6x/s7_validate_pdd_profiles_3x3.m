%% s9_validate_pdd_profiles_3x3.m  –  TrueBeam 6X (6MV flat)
...
figure('Name','PDD – 3x3 cm², TrueBeam 6X','Position',[50 100 700 500]);
...
title('PDD – TrueBeam 6X, 3×3 cm², SSD=100 cm');
...
for k = 1:length(profile_depths_cm)
    ...
    ylabel('Relative Dose [%]');
    title(sprintf('Profile at %.1f cm (grid: %.1f mm) – TrueBeam 6X, 3×3 cm²', ...
...
%% 15. Save
save('s7_water_phantom_3x3_6x_results.mat', ...
    ...
    'profile_depths_cm');
fprintf('\nSaved: s7_water_phantom_3x3_6x_results.mat\n');
